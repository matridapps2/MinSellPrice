...
class FeaturedBrandModel {
  ...
  factory FeaturedBrandModel.fromRawJson(String str) => FeaturedBrandModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory FeaturedBrandModel.fromJson(Map<String, dynamic> json) => FeaturedBrandModel(
